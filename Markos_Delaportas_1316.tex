...
%\def\pdfximage{\pdfextension ximage}
%\def\pdfrefximage{\pdfextension refximage}

\usepackage{siunitx} % \SI{}{} commands
\usepackage{subfiles}
...
\usepackage[record, abbreviations, acronym, stylemods={long}]{glossaries-extra}
...
\usepackage[ backend=biber, bibencoding=utf8, style=ieee, sorting=nyt]{biblatex}
...
\clearpage
    ...
    \IfFileExists{Introduction.tex}{\subfile{Introduction}}{}
    \IfFileExists{IdealOTA.tex}{\subfile{IdealOTA}}{}
     % \IfFileExists{otaFoundationsAndTechniques.tex}{\subfile{otaFoundationsAndTechniques}}{}
    \IfFileExists{SystemModelAndChallenges.tex}{\subfile{SystemModelAndChallenges}}{}
    \IfFileExists{ExperimentalImplementation.tex}{\subfile{ExperimentalImplementation}}{}
    \IfFileExists{ResultsAndDiscussion.tex}{\subfile{ResultsAndDiscussion}}{}
    \IfFileExists{ConclusionAndFutureWork.tex}{\subfile{ConclusionAndFutureWork}}{}

    \begin{appendices}
        % (Changes A.a to A.1)
        \renewcommand{\thesubsection}{\thesection.\arabic{subsection}}
        
        \IfFileExists{Appendix_A.tex}{\subfile{Appendix_A}}{}
    \end{appendices}
