...
%\usepackage{cleveref}
\usepackage{mathtools}
\usepackage[warnings-off={mathtools-common, mathtools-overbracket}]{unicode-math}
...
\textbf{ \textit{Abstract} -- Over The Air Computing (\gls{ota}) is an
...
\end{itemize}
    ...
    the signal superposition in the \gls{mac}.
