...
\begin{document}
    ...
    \begin{figure}[htpb]
        ...
        \caption{Simulink block diagram representing the ideal OTA computation network over an \gls{awgn} channel.}
        \label{fig:idealOTA_MSE_simulink} 
    \end{figure}    
        ...
        \begin{subfigure}{.45\linewidth}
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    width=0.8\textwidth,
                    height=0.5\textwidth,
                    legend pos=outer north east, % Moves legend outside to avoid covering 800 data points
                    mark=none, % Disables markers. 800 markers on a line looks like a thick smudge!
                    thick
                ]
                    \addplot[
                        color=blue,
    ...
    \begin{figure}[htbp]
        ...
        \begin{subfigure}{.45\linewidth}
            \begin{tikzpicture}
                \begin{axis}[
                    title={\textsf{Eye Diagram Matched Filter}},
                    xlabel={Time}, ylabel={Real Amplitude},
                    grid=major,
                    width=0.8\textwidth,
                    height=0.5\textwidth,
                    legend pos=outer north east, % Moves legend outside to avoid covering 800 data points
                ...
                \end{axis}
            \end{tikzpicture}
            \caption{Eye Diagram of the ideal OTA computation network over an \gls{awgn} channel.}
            \label{fig:simulink_Eye_ideal}
        \end{subfigure}%
        \hfill
        \begin{subfigure}{.45\linewidth}
            \begin{tikzpicture}
                \begin{axis}[
                    title={\textsf{Eye Diagram No filter}},
                    xlabel={Time}, ylabel={Real Amplitude},
                    grid=major,
                    width=0.8\textwidth,
                    height=0.5\textwidth,
                ...
                \end{axis}
            \end{tikzpicture}
            \caption{Eye Diagram of the Raised Cosine filtered OTA computation network over an \gls{awgn} channel.}
            \label{fig:simulink_Eye_rc}
        \end{subfigure}
        \caption{Simulink Eye Diagrams}
        \label{fig:simulink_eye}
    \end{figure}
    ...
    \begin{figure}[htpb]
        ...
        \caption{GNU Radio Eye \& Constellation Diagram for the ideal, Nyquist-compliant scenario.}
