...
\begin{document}
        ...
        \begin{minipage}{.45\textwidth}
            \begin{tikzpicture}
                \begin{axis}[ 
                    ...
                    \addplot table[x index=1, y index=0, col sep=tab] {data/MSEvsSNR_ideal.txt};
    ...
    \begin{figure}[htbp]
        ...
        \begin{luacode*}
            -- 1. Define your array of simulation parameters.
            local sps_data = {
            ...
            tex.print("\\begin{animateinline}[controls, autoplay, loop]{1.5}")
                ...
                for i, sps in ipairs(sps_data) do
                    ...
                    tex.print("    zmode=log,")
                    tex.print("    zmin=0.1, zmax=7000,")
                    tex.print("    view={60}{30},")
                    ...
                    tex.print("\\addplot3[surf] table[x=SNR_dB, y=RollOff, z=MSE] {data/MSEvsSNR_" .. sps.val .. "sps.txt};")
                    
                    tex.print("\\end{axis}")
                    tex.print("\\end{tikzpicture}")
                end
            
            -- 4. End the animate environment FROM LUA
